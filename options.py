...
def options():
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10',choices=['CIFAR10','CIFAR100','CIFAR10_partial'])
    parser.add_argument('--partial_data_pc', default=1.0, type=float)
    parser.add_argument('--partial_data_style', default='random' , type=str,choices = ['random','halfsplit','curated'])
    parser.add_argument('--load_net', type=str, default=None)
    parser.add_argument('--load_data', type=str, default=None)
    parser.add_argument('--save_net', type=str, default="checkpoint")
    ...
    parser.add_argument('--set_init_seed', default=1 , type=int)
